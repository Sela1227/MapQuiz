...
| V2.7.1 | **全庫語句盤檢**：validator 機械層全綠（過短/亂碼/重複/洩答零問題，證明 V2.5.0 後新資料都被守過）；啟發式撈出 124 對疑似重複，人工複核挑出 **11 條真正同義反覆**改寫分散（直接改 data-src 主檔，delta 只增不改）；validator 補中文語法註解，記錄「缺動詞≠半截句」避免再生 2847 條誤報 |
