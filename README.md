...
- **小知識系統**：世界 196 國（全數 ≥8 段、熱門 33 國 15 段，共 1,802 條）＋台灣 22 縣市（各 10 段、共 220 條）＋165 個台灣景點與 183 個世界地標的一句說明（地標題答完顯示該地標介紹）；答題後隨機顯示**並標明國名/縣市/景點名**加深印象、自由練習點選也會出現
...
<div align="center">
  ...
  <br/>
  <sub>Made by <strong>SELA</strong> · V2.3.0</sub>
</div>
