...
- **小知識系統**：世界 196 國（非熱門 ≥12 段、熱門 33 國 15 段，共 1,802 條）＋台灣 22 縣市（各 10 段、共 220 條）＋台灣 165 景點、世界地標（含熱門國擴充後）**各 3 句說明**（共 1,044 句，答題隨機顯示其一，減少重複感）；答題後隨機顯示**並標明國名/縣市/景點名**加深印象、自由練習點選也會出現
...
<div align="center">
  ...
  <br/>
  <sub>Made by <strong>SELA</strong> · V2.8.0</sub>
</div>
