...
- **世界國家**：196 國＝193 聯合國會員＋梵蒂岡＋巴勒斯坦＋台灣；**太平洋置中投影（台灣居中）**；看地圖選名字／地標題**緊聚焦目標國**、看名字點地圖聚焦到洲、選項不跨洲；**可先選洲再作答**（全部／六大洲）；地圖支援**滑鼠滾輪**與**雙指捏合**快速縮放（世界題可一路縮小看更大範圍），單指拖曳平移；微型國有點擊範圍、可放大至 4×
- **PWA**：可「加入主畫面」安裝、離線遊玩（service worker 快取全部資源）
- **小知識系統**：世界 196 國（熱門 33 國 15 段、共 1,310 條）＋台灣 22 縣市（各 5 段）＋165 個景點一句說明；答題後隨機顯示**並標明國名/縣市/景點名**加深印象、自由練習點選也會出現
- **知名度加權出題**：世界題依國家知名度三級加權（家喻戶曉 5：有地標 2：其餘 1），避免冷門國連發的挫折感（「只考錯的」重練不加權）
- **首都題**：196 國首都全收錄；「首都含國名」者（如墨西哥城）依洩答規則不出題、僅供顯示，出題池 183 個
...
<div align="center">
  ...
  <br/>
  <sub>Made by <strong>SELA</strong> · V2.1.0</sub>
</div>
